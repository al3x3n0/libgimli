...
const std::vector<SupportMatrixRow>& getSupportMatrixRows() {
    static const std::vector<SupportMatrixRow> kRows = {
        ...
        {"expr", "unknown vendor/extension opcodes", "unsupported",
         "opcodes outside the known GNU set remain rejected by design while preserving unsupported_opcode/unsupported_vendor_extension diagnostics and compare-expr unsupported_isolated reporting"},
        {"expr", "runtime expression gap telemetry", "supported",
         "dwarf_dump --show-support can summarize runtime-observed unknown expression opcodes and the attributes carrying them for a loaded file; compare-expr reports can further isolate unsupported rows and range segments"},
